...
public class AlgaeSubsystemV3 extends ProfiledPIDSubsystem {

  private final SparkMax algaeArmMotor = new SparkMax(AlgaeConstants.ALGAE_MANIP_PORT, MotorType.kBrushless);
  ...
  public void intakeAlgaeManual(){
    algaeIntakeMotor.setVoltage(3);
  }

  /*  version with current spike (don't want) 
